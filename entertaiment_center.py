...
schindlers = media.Movie(
    ...
    "https://www.o-cinema.org/wp-content/uploads/2015/06/schindlers-list-52e73e7ba8e35-260x371.jpg",  # NOQA
...
avengers = media.Movie(
    ...
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMTk2NTI1MTU4N15BMl5BanBnXkFtZTcwODg0OTY0Nw@@._V1_UX182_CR0,0,182,268_AL_.jpg",  # NOQA
    "https://www.youtube.com/watch?v=eOrNdBpGMv8")

john_wick = media.Movie(
    "John Wick Chapter 2",
    "After returning to the criminal underworld "
    "to repay a debt, John Wick discovers that "
    "a large bounty has been put on his life.",
    "http://www.dvdsreleasedates.com/posters/300/J/John-Wick-Chapter-Two-2017.jpg",  # NOQA
    "https://www.youtube.com/watch?v=XGk2EfbD_Ps")

now = media.Movie(
    "Now you see me",
    "An F.B.I. Agent, and an Interpol Detective, "
    "track a team of illusionists, who pull off "
    "bank heists during their performances, "
    "and reward their audiences with the money.",
    "https://upload.wikimedia.org/wikipedia/en/thumb/9/9a/Now_You_See_Me_2_poster.jpg/220px-Now_You_See_Me_2_poster.jpg",  # NOQA
...
wolverine = media.Movie(
    ...
    "A look at Wolverine's early life, in particular "
    "his time with the government squad Team X and the "
    "impact it will have on his later years.",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BZWRhMzdhMzEtZTViNy00YWYyLTgxZmUtMTMwMWM0NTEyMjk3XkEyXkFqcGdeQXVyNTIzOTk5ODM@._V1_UX182_CR0,0,182,268_AL_.jpg",  # NOQA
    "https://www.youtube.com/watch?v=kd6zYnHwQWA")

list = [schindlers, avengers, john_wick, now, inception, wolverine]

# generate the file (.html) that show the movies information
